...
import { RelayTimelineChannel } from '@/server/api/stream/channels/relay-timeline.js';
...
import { DrawRoomChannel } from '@/server/api/stream/channels/draw-room.js';
...
export default class Connection {
	...
	public getChannelConstructor(name: string): ChannelConstructor<boolean> {
		switch (name) {
			...
			case 'relayTimeline': return RelayTimelineChannel;
			...
			case 'drawRoom': return DrawRoomChannel;
