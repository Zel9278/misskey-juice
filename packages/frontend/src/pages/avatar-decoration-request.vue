	...
	<div class="_spacer" style="--MI_SPACER-w: 700px; --MI_SPACER-min: 16px; --MI_SPACER-max: 32px;">
		...
		<template v-else>
			<div v-if="tab === 'form'" class="_gaps_m">
				...
				<MkInfo v-if="dailyRemaining === 0" warn>{{ i18n.ts._avatarDecorationRequestPage.dailyLimitReached }}</MkInfo>
				<MkInfo v-else-if="dailyRemaining != null">{{ i18n.tsx._avatarDecorationRequestPage.dailyRemainingCount({ remaining: dailyRemaining }) }}</MkInfo>
