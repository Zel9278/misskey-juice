...
// JUICE: 未対応の通報・絵文字申請・承認式登録申請等があるかどうかのバナー用stateと、
// リアルタイム購読(admin stream)はcommon.vue側でアプリ起動時に一度だけ開始し
// (モデレーターでなくてもcanApproveEmojiRequests等のロールポリシーを持つユーザーが対象になるため
// このページに限定できない)、ここではそのstateを読み取って表示するだけにする
