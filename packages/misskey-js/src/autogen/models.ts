...
export type EmojiRequestEntry = components['schemas']['EmojiRequestEntry'];
export type EmojiRequestEntryDetailedAdmin = components['schemas']['EmojiRequestEntryDetailedAdmin'];
export type AvatarDecorationRequestEntry = components['schemas']['AvatarDecorationRequestEntry'];
export type AvatarDecorationRequestEntryDetailedAdmin = components['schemas']['AvatarDecorationRequestEntryDetailedAdmin'];
