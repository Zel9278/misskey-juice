...
export type AdminAvatarDecorationRequestsApproveRequest = operations['admin___avatar-decoration-requests___approve']['requestBody']['content']['application/json'];
export type AdminAvatarDecorationRequestsListRequest = operations['admin___avatar-decoration-requests___list']['requestBody']['content']['application/json'];
export type AdminAvatarDecorationRequestsListResponse = operations['admin___avatar-decoration-requests___list']['responses']['200']['content']['application/json'];
export type AdminAvatarDecorationRequestsRejectRequest = operations['admin___avatar-decoration-requests___reject']['requestBody']['content']['application/json'];
...
export type AdminContactFormCategoriesResponse = operations['admin___contact-form___categories']['responses']['200']['content']['application/json'];
...
export type AdminDriveFindOrphanedObjectStorageFilesRequest = operations['admin___drive___find-orphaned-object-storage-files']['requestBody']['content']['application/json'];
export type AdminDriveFindOrphanedObjectStorageFilesResponse = operations['admin___drive___find-orphaned-object-storage-files']['responses']['200']['content']['application/json'];
...
export type AdminEmojiRequestsApproveRequest = operations['admin___emoji-requests___approve']['requestBody']['content']['application/json'];
export type AdminEmojiRequestsListRequest = operations['admin___emoji-requests___list']['requestBody']['content']['application/json'];
export type AdminEmojiRequestsListResponse = operations['admin___emoji-requests___list']['responses']['200']['content']['application/json'];
export type AdminEmojiRequestsRejectRequest = operations['admin___emoji-requests___reject']['requestBody']['content']['application/json'];
...
export type AdminJuiceApproveSignupRequest = operations['admin___juice___approve-signup']['requestBody']['content']['application/json'];
export type AdminJuiceDeclineSignupRequest = operations['admin___juice___decline-signup']['requestBody']['content']['application/json'];
export type AdminJuicePendingSignupsRequest = operations['admin___juice___pending-signups']['requestBody']['content']['application/json'];
export type AdminJuicePendingSignupsResponse = operations['admin___juice___pending-signups']['responses']['200']['content']['application/json'];
export type AdminJuiceSettingsResponse = operations['admin___juice___settings']['responses']['200']['content']['application/json'];
export type AdminJuiceSignupApprovalHistoryRequest = operations['admin___juice___signup-approval-history']['requestBody']['content']['application/json'];
export type AdminJuiceSignupApprovalHistoryResponse = operations['admin___juice___signup-approval-history']['responses']['200']['content']['application/json'];
export type AdminJuiceUpdateSettingsRequest = operations['admin___juice___update-settings']['requestBody']['content']['application/json'];
...
export type AvatarDecorationRequestsCreateManyResponse = operations['avatar-decoration-requests___create-many']['responses']['200']['content']['application/json'];
export type AvatarDecorationRequestsListRequest = operations['avatar-decoration-requests___list']['requestBody']['content']['application/json'];
export type AvatarDecorationRequestsListResponse = operations['avatar-decoration-requests___list']['responses']['200']['content']['application/json'];
...
export type DrawRoomsChatHistoryRequest = operations['draw-rooms___chat-history']['requestBody']['content']['application/json'];
export type DrawRoomsChatHistoryResponse = operations['draw-rooms___chat-history']['responses']['200']['content']['application/json'];
export type DrawRoomsCreateRequest = operations['draw-rooms___create']['requestBody']['content']['application/json'];
export type DrawRoomsCreateResponse = operations['draw-rooms___create']['responses']['200']['content']['application/json'];
export type DrawRoomsDeleteRequest = operations['draw-rooms___delete']['requestBody']['content']['application/json'];
export type DrawRoomsEndRequest = operations['draw-rooms___end']['requestBody']['content']['application/json'];
export type DrawRoomsEndResponse = operations['draw-rooms___end']['responses']['200']['content']['application/json'];
export type DrawRoomsJoinRequest = operations['draw-rooms___join']['requestBody']['content']['application/json'];
export type DrawRoomsKickRequest = operations['draw-rooms___kick']['requestBody']['content']['application/json'];
export type DrawRoomsLeaveRequest = operations['draw-rooms___leave']['requestBody']['content']['application/json'];
export type DrawRoomsListRequest = operations['draw-rooms___list']['requestBody']['content']['application/json'];
export type DrawRoomsListResponse = operations['draw-rooms___list']['responses']['200']['content']['application/json'];
export type DrawRoomsShowRequest = operations['draw-rooms___show']['requestBody']['content']['application/json'];
export type DrawRoomsShowResponse = operations['draw-rooms___show']['responses']['200']['content']['application/json'];
export type DrawRoomsStrokesRequest = operations['draw-rooms___strokes']['requestBody']['content']['application/json'];
export type DrawRoomsStrokesResponse = operations['draw-rooms___strokes']['responses']['200']['content']['application/json'];
export type DrawRoomsUpdateRequest = operations['draw-rooms___update']['requestBody']['content']['application/json'];
export type DrawRoomsUpdateResponse = operations['draw-rooms___update']['responses']['200']['content']['application/json'];
...
export type EmojiRequestsCreateManyResponse = operations['emoji-requests___create-many']['responses']['200']['content']['application/json'];
export type EmojiRequestsListRequest = operations['emoji-requests___list']['requestBody']['content']['application/json'];
export type EmojiRequestsListResponse = operations['emoji-requests___list']['responses']['200']['content']['application/json'];
...
export type IOauthSetLoginEnabledRequest = operations['i___oauth___set-login-enabled']['requestBody']['content']['application/json'];
...
export type JuiceRelaysResponse = operations['juice___relays']['responses']['200']['content']['application/json'];
export type JuiceSignupCheckStatusRequest = operations['juice___signup-check-status']['requestBody']['content']['application/json'];
export type JuiceSignupCheckStatusResponse = operations['juice___signup-check-status']['responses']['200']['content']['application/json'];
...
export type NotesJuiceUpdateAiGeneratedRequest = operations['notes___juice___update-ai-generated']['requestBody']['content']['application/json'];
export type NotesJuiceUpdateAiGeneratedResponse = operations['notes___juice___update-ai-generated']['responses']['200']['content']['application/json'];
export type NotesJuiceUpdateNovelRequest = operations['notes___juice___update-novel']['requestBody']['content']['application/json'];
export type NotesJuiceUpdateNovelResponse = operations['notes___juice___update-novel']['responses']['200']['content']['application/json'];
...
export type NotesRelayTimelineRequest = operations['notes___relay-timeline']['requestBody']['content']['application/json'];
export type NotesRelayTimelineResponse = operations['notes___relay-timeline']['responses']['200']['content']['application/json'];
...
export type OauthLoginLinkStartRequest = operations['oauth-login___link-start']['requestBody']['content']['application/json'];
export type OauthLoginLinkStartResponse = operations['oauth-login___link-start']['responses']['200']['content']['application/json'];
export type OauthLoginListConnectionsResponse = operations['oauth-login___list-connections']['responses']['200']['content']['application/json'];
export type OauthLoginSigninStartRequest = operations['oauth-login___signin-start']['requestBody']['content']['application/json'];
export type OauthLoginSigninStartResponse = operations['oauth-login___signin-start']['responses']['200']['content']['application/json'];
export type OauthLoginUnlinkRequest = operations['oauth-login___unlink']['requestBody']['content']['application/json'];
