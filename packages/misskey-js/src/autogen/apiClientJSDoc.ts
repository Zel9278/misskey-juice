...
declare module '../api.js' {
  export interface APIClient {
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *write:admin:avatar-decoration-requests-approve*
     */
    request<E extends 'admin/avatar-decoration-requests/approve', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *read:admin:avatar-decoration-requests*
     */
    request<E extends 'admin/avatar-decoration-requests/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *write:admin:avatar-decoration-requests-reject*
     */
    request<E extends 'admin/avatar-decoration-requests/reject', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     */
    request<E extends 'admin/contact-form/categories', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * Find (and optionally delete) object storage objects that are no longer referenced by any drive file. Deletion is immediate and irreversible, so `dryRun` defaults to true.
     * 
     * **Credential required**: *Yes* / **Permission**: *write:admin:drive*
     */
    request<E extends 'admin/drive/find-orphaned-object-storage-files', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *write:admin:emoji-requests-approve*
     */
    request<E extends 'admin/emoji-requests/approve', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *read:admin:emoji-requests*
     */
    request<E extends 'admin/emoji-requests/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *write:admin:emoji-requests-reject*
     */
    request<E extends 'admin/emoji-requests/reject', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *write:admin:juice-approve-signup*
     */
    request<E extends 'admin/juice/approve-signup', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *write:admin:juice-decline-signup*
     */
    request<E extends 'admin/juice/decline-signup', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *read:admin:juice-pending-signups*
     */
    request<E extends 'admin/juice/pending-signups', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     */
    request<E extends 'announcements/polls/vote', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     */
    request<E extends 'draw-rooms/create', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:draw-rooms*
     */
    request<E extends 'draw-rooms/delete', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:draw-rooms*
     */
    request<E extends 'draw-rooms/end', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:draw-rooms*
     */
    request<E extends 'draw-rooms/kick', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:draw-rooms*
     */
    request<E extends 'draw-rooms/leave', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:draw-rooms*
     */
    request<E extends 'draw-rooms/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:draw-rooms*
     */
    request<E extends 'draw-rooms/update', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:emoji-requests*
     */
    request<E extends 'emoji-requests/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'i/juice/update-mute-ai-generated', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes*
     */
    request<E extends 'i/oauth/set-login-enabled', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'juice/ranking', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'juice/relays', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:notes*
     */
    request<E extends 'notes/juice/update-ai-generated', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:notes*
     */
    request<E extends 'notes/juice/update-novel', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'notes/relay-timeline', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes*
     */
    request<E extends 'oauth-login/link-start', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes*
     */
    request<E extends 'oauth-login/list-connections', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'oauth-login/signin-start', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes*
     */
    request<E extends 'oauth-login/unlink', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
